        ...
        self.addEventListener('message', function(evt) {
            ...
            for (var row = 0; row < h; ++row) {
                for (var col = 0; col < w; ++col) {
                    ...
                    buf[(h - 1 - row) * w * 4 + col * 4 + 0] = (1 - alpha) * 255 + alpha * buf[(h - 1 - row) * w * 4 + col * 4 + 0]
                    buf[(h - 1 - row) * w * 4 + col * 4 + 1] = (1 - alpha) * 255 + alpha * buf[(h - 1 - row) * w * 4 + col * 4 + 1]
                    buf[(h - 1 - row) * w * 4 + col * 4 + 2] = (1 - alpha) * 255 + alpha * buf[(h - 1 - row) * w * 4 + col * 4 + 2]
